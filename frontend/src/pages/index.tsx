            ...
            <CardBox className='w-full md:w-3/5 lg:w-2/3'>
              ...
              <div className='space-y-3'>
                <p className='text-center text-gray-500'>
                  ...
                  <a
                    className={`${textColor}`}
                    href='https://saashqdev.com/generator'
                  >
                    saashqdev Web App Generator
                  </a>
                </p>
                <p className='text-center text-gray-500'>
                  ...
                  <a
                    className={`${textColor}`}
                    href='https://saashqdev.com/documentation'
                  >
                    saashqdev documentation
                  </a>
                </p>
              </div>
              <BaseDivider />
              ...
              <div className='grid grid-cols-1 gap-2 lg:grid-cols-4 mt-2'>
                ...
                <div className='text-center'>
                  <a
                    className={`${textColor}`}
                    href='https://saashqdev.com/forum'
                  >
                    saashqdev Forum
                  </a>
                </div>
