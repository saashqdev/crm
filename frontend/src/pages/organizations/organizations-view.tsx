        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>
              Customer_interactions organization
            </p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.customer_interactions_organization &&
                      Array.isArray(
                        organizations.customer_interactions_organization,
                      ) &&
                      organizations.customer_interactions_organization.map(
                        (item: any) => (
                          <tr
                            key={item.id}
                            onClick={() =>
              ...
              {!organizations?.customer_interactions_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Opportunities organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.opportunities_organization &&
                      Array.isArray(organizations.opportunities_organization) &&
                      organizations.opportunities_organization.map(
                        (item: any) => (
                          <tr
                            key={item.id}
                            onClick={() =>
              ...
              {!organizations?.opportunities_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
