...
const Dashboard = () => {
  ...
  const [customer_interactions, setCustomer_interactions] =
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_CUSTOMER_INTERACTIONS') && (
          ...
          {hasPermission(currentUser, 'READ_OPPORTUNITIES') && (
            <Link href={'/opportunities/opportunities-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
