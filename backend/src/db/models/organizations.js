...
module.exports = function (sequelize, DataTypes) {
  ...
  organizations.associate = (db) => {
    ...
    db.organizations.hasMany(db.customer_interactions, {
      as: 'customer_interactions_organization',
      foreignKey: {
        name: 'organizationId',
      },
      constraints: false,
    ...
    db.organizations.hasMany(db.opportunities, {
      as: 'opportunities_organization',
      foreignKey: {
        name: 'organizationId',
      },
      constraints: false,
