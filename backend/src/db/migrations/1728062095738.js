module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('opportunities', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('opportunities', 'leadId', {
        transaction,
      });

      await queryInterface.removeColumn('opportunities', 'close_date', {
        transaction,
      });

      await queryInterface.removeColumn('opportunities', 'value', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('customer_interactions', 'userId', {
        transaction,
      });

      await queryInterface.removeColumn('customer_interactions', 'contactId', {
        transaction,
      });

      await queryInterface.removeColumn('customer_interactions', 'notes', {
        transaction,
      });
      ...
      await queryInterface.dropTable('customer_interactions', { transaction });
