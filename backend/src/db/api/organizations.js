...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.customer_interactions_organization =
      await organizations.getCustomer_interactions_organization({
        transaction,
      });
    ...
    output.opportunities_organization =
      await organizations.getOpportunities_organization({
        transaction,
      });
